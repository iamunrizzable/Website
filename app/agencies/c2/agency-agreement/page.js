  ...
  return (
    <>
      ...
      <main>
        ...
        <p className="subtitle">Effective Date: August 22, 2025. This is the full text of C2 Capital Group Inc.&apos;s own C2 Live Streamer Agency Agreement, reproduced here for TJB Management creators, plus C2&apos;s own Agencies FAQ. This is C2&apos;s contract, not TJB Management&apos;s — it governs everyone who joins an Agency on C2, including TJB Management&apos;s. The official Agreement at c2live.co and C2&apos;s Terms at c2live.co/terms govern.</p>
        ...
        <div className="toc">
          ...
          <ol>
            ...
            <li><a href="#faq">C2 Agencies FAQ</a></li>
          </ol>
        </div>
        ...
        <div className="section" id="faq">
          ...
          <p><strong>Are there any requirements to start an agency?</strong></p>
          <p>Any C2 user can start an agency.</p>
