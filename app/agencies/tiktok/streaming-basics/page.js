    ...
    <>
      ...
      <main>
        ...
        <div className="section" id="rules">
          ...
          <p><a href="/agencies/tiktok/tiktok/community/guidelines" style={{ color: '#a855f7', textDecoration: 'none' }}>See the full breakdown of TikTok's Community Guidelines →</a></p>
        </div>
