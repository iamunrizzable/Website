...
export async function GET() {
  ...
  const res = await fetch(
    `https://business-api.tiktok.com/open_api/v1.3/business/get/?business_id=${encodeURIComponent(businessId)}&fields=display_name,profile_image,follower_count,likes_count,video_count`,
