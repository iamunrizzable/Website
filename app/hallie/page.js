      ...
      <head>
        ...
        <style>{`
          * { margin: 0; padding: 0; box-sizing: border-box; }
          ...
          main { min-height: 100vh; display: flex; flex-direction: column; justify-content: center; align-items: center; padding: 40px 20px; position: relative; background-color: #0f172a; }
          ...
          h1 { color: #a855f7; font-size: 48px; margin-bottom: 40px; text-align: center; }
          .bio-section { background: rgba(168, 85, 247, 0.05); padding: 40px; border-left: 4px solid #a855f7; border-radius: 8px; margin-bottom: 40px; }
          .bio-section p { font-size: 18px; line-height: 1.8; color: #ddd; margin-bottom: 15px; }
          .bio-section p:last-child { margin-bottom: 0; }
          .footer { text-align: center; padding-top: 30px; border-top: 1px solid rgba(255,255,255,0.1); font-size: 14px; color: #888; }
          @media (max-width: 640px) { h1 { font-size: 32px; } .bio-section { padding: 20px; } .bio-section p { font-size: 16px; } main { padding: 20px; } }
        `}</style>
      </head>
      <body>
