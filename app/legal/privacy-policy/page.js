    ...
    <>
      ...
      <main>
        ...
        <div className="section" id="privacy-info-collected">
          ...
          <p>
            The Website's contact pages (<span className="rainbow">/tiktok/agency/connect</span>, <span className="rainbow">/tyler/about/tyler</span>, <span className="rainbow">/contact-hallie</span>) are directories of direct contact links — email and phone — and do not contain forms that collect or transmit visitor information to TJB Management.
          </p>
          <p>
