    ...
    <>
      ...
      <main>
        ...
        <div className="section">
          ...
          <ul>
            <li><strong>Step 1 — Viewers buy TikTok Coins.</strong> Coins are TikTok's in-app currency. Roughly <span className="highlight">65–70 coins</span> costs viewers about <span className="highlight">$1 USD</span>, purchased through the TikTok app.</li>
            <li><strong>Step 2 — They spend coins on gifts.</strong> Gifts range from a Rose (<span className="highlight">1 coin</span>) all the way up to the Universe (<span className="highlight">44,999 coins</span>, worth over <span className="highlight">$560</span> to the sender). Every gift has a coin cost the viewer pays upfront.</li>
            ...
            <li><strong>Step 4 — You get paid.</strong> TikTok automatically sends your diamond earnings every <span className="highlight">Wednesday</span>. The minimum payout is <span className="highlight">$1 USD</span>. You must be <span className="highlight">18 or older</span> to receive earnings.</li>
          </ul>
          <p>
        ...
        <div className="section">
          ...
          <p>
            Each diamond has a base value of <span className="highlight">$0.01 USD</span>, but your actual payout depends on your rewards percentage. The formula is: <span className="highlight">diamonds × $0.01 × your rewards %</span>. For example, at a <span className="highlight">36.5% rewards rate</span>, 41,200 diamonds pays out <span className="highlight">$150.38</span>.
          </p>
          <p>
            <strong>Scaled LIVE Rewards</strong> is TikTok's mission-based payout system. Your rewards percentage goes up when you complete missions during each LIVE and each week — the maximum rate is <span className="highlight">53%</span>. Creators who don't complete missions earn less. This is why consistent streaming and hitting mission targets directly affects how much money you take home.
          </p>
          <ul>
            <li><strong>Per-LIVE Missions — up to 40%:</strong> based on stream duration, new followers gained, and content quality</li>
            <li><strong>Weekly Missions — up to 13%:</strong> based on valid LIVE days, active fan engagement, and Creator League rank</li>
          </ul>
        </div>
