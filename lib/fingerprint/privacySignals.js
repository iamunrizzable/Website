...
// Deliberately NOT folded into lib/fingerprint/collect.js's `components` —
// that object is hashed into visitorId and diffed for device
// *identification*; these probes can vary session-to-session for the same
// physical device (a private window vs. a normal one), which would
// corrupt identification rather than inform it.
