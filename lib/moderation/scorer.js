...
export const CATEGORY_META = {
  potential_minor: { label: 'Potential Minor Detection', description: 'Age statements, school grades, "minor"/"underage" — also queues the account block-queue when enabled.' },
