...
// potential_minor is toggleable like every other category — disabling it
// also disables the block-queue/email-alert pipeline for that account,
// since both are driven off the same 'potential_minor' flag in lib/sync.js.
export const CATEGORY_META = {
  potential_minor: { label: 'Potential Minor Detection', description: 'Age statements, school grades, "minor"/"underage" — also queues the account block-queue and email alert when enabled.' },
