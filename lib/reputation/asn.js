...
// peers. Used only for near-miss/block enrichment (rare), never on the
// hot allowed-visit path — a DNS lookup, even a fast one, has no business
// slowing down every page load.
//
