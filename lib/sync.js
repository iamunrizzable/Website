...
import { pushEvent, isCommentSeen, markCommentSeen, queueBlock, getCustomRules, getCategoryFilters } from './tokens.js';
  ...
  for (const video of targetVideos) {
    ...
    while (true) {
      ...
      for (const comment of comments) {
        ...
        const { score, flags, action } = scoreContent(comment.text, customRules, categoryFilters);
