...
// Same self-hosted pattern as the IP blocklist above, but keyed on
// Fingerprint's visitor_id instead of IP. A device's visitor_id stays
// stable across IP changes (unlike IP, which mobile carriers rotate
// constantly — the exact problem that made IP-only blocking unreliable),
// so this is what makes a block actually stick to a specific device
// rather than a specific network address. Checked in
